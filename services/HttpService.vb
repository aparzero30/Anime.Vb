...
Public Class HttpService
    ...
    Public Async Function GetTopAiring(page As Integer) As Task(Of ApiResponse)
        Dim httpClient As New HttpClient()
        Dim apiUrl As String = baseUrl + "/top-airing"

        Try
            Dim queryParams As New List(Of KeyValuePair(Of String, String))
            queryParams.Add(New KeyValuePair(Of String, String)("page", page.ToString()))
    ...
    Public Async Function SearchAnime(key As String, page As Integer) As Task(Of ApiResponse)
        Dim httpClient As New HttpClient()
